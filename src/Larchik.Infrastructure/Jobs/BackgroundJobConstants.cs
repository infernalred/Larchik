...
public static class BackgroundJobConstants
{
    ...
    public const string PortfolioReconciliationDailyDefinitionName = "portfolio_reconciliation_daily";
    public const string PortfolioReconciliationDailyJobType = "reconciliation.daily";
